...
df_s <- data_frame(t_a = seq (from = -20, to = 45, by = 1),
...
# Question 4A:
How does the starting delta value of the atmosphere combined with the relative humididty affect the delta of the evaporated water?
